          ...
          <div className="container-lux relative z-10 grid gap-12 lg:grid-cols-[0.82fr_1fr]">
            <Reveal>
              ...
              <div className="mt-10 grid gap-6 text-ivory/82">
                ...
                <a className="flex items-center gap-4" href="mailto:contact@meghabuildersanddevelopers.com"><BookOpen className="text-gold" /> contact@meghabuildersanddevelopers.com</a>
              </div>
